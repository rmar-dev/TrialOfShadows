...
namespace _Scripts.Character.StateMachineBehaviors.Player
{
        ...
        where TMonoBehaviour : MonoBehaviour
    {
        ...
        private bool mFirstFrameHappened;
        private bool mLastFrameHappened;
        ...
        public sealed override void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex, AnimatorControllerPlayable controller)
        {
            ...
            if (!animator.IsInTransition(layerIndex) && mFirstFrameHappened)
            {
            ...
            if (animator.IsInTransition(layerIndex) && !mLastFrameHappened && mFirstFrameHappened)
            {
                mLastFrameHappened = true;
